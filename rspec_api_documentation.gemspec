...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "fakefs", "~> 0.12.0"
  ...
  s.add_development_dependency "rack-test", "~> 0.8.2"
  s.add_development_dependency "rack-oauth2", "~> 1.7"
  s.add_development_dependency "webmock", "~> 3.2"
  s.add_development_dependency "rspec-its", "~> 1.2"
  s.add_development_dependency "faraday", "~> 0.13.1"
